...
function gerarPedidoExclusao(msg,tipo,layout,acaoBtOk,codigo,txBtCancelar){
 var n = noty({
            text        : msg,
            type        : tipo,
            dismissQueue: true,
            ...
            buttons     : [
                ...
                {addClass: 'btn btn-danger', text: txBtCancelar, onClick: function ($noty) {
                   $noty.close();
...
function gerarPedidoExclusaoDoc(msg,tipo,layout,acaoBtOk,codigo,data,nome,txBtCancelar){
 var n = noty({
            text        : msg,
            type        : tipo,
            dismissQueue: true,
...
function gerarPedidoContinuarCadastro(msg,tipo,layout,acaoBtOk,acaoBtCancelar,txBtYes,txBtNo){
 var n = noty({
            text        : msg,
            type        : tipo,
            dismissQueue: true,
            ...
            theme       : 'defaultTheme',
            buttons     : [
                {addClass: 'btn btn-primary', text:txBtYes, onClick: function ($noty)  {
                    window.location="index.php?acao="+acaoBtOk;
                }
                },
                {addClass: 'btn btn-danger', text:txBtNo, onClick: function ($noty) {
